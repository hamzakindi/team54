...
export default function PredictionForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl">
      <h2 className="text-3xl font-bold mb-8 text-gray-800 text-center">Diabetes Risk Assessment</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Form Section */}
        <div className="md:border-r md:pr-8">
          <h3 className="text-xl font-semibold mb-6 text-gray-700">Patient Information</h3>
        ...
        {/* Results Section */}
        <div className={`${prediction ? 'block' : 'hidden md:block'}`}>
          {prediction ? (
            <div className="space-y-6">
              <h3 className="text-xl font-semibold mb-6 text-gray-700">Assessment Results</h3>
              ...
              {testRecommendations.length > 0 && (
                <div className="mt-8">
                  <h4 className="text-lg font-semibold mb-4">Recommended Tests</h4>
            ...
            <div className="flex items-center justify-center h-full">
              <p className="text-gray-500 text-center">
                Enter patient information and click &quot;Analyze Risk&quot; to see the assessment results
              </p>
            </div>
          )}
        </div>
